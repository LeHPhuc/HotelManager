...
if __name__ == '__main__':
    with app.app_context():
        ...
        u3 = User(username='phuc', password=password_3, name='Trần Quang Phục', email='plehoang641@gmail.com', birthday=datetime(2004, 2, 6), avatar='static/images/default.jpg', user_role_id=3)
        password_4 = str(hashlib.md5('nhat'.encode('utf-8')).hexdigest())
        u4 = User(username='nhat', password=password_4, name='Nguyễn Thành Nhật', email='plehoang641@gmail.com', birthday=datetime(2004, 2, 6), avatar='images/1.jpg', user_role_id=3)
        db.session.add(u1)
        db.session.add(u2)
        db.session.add(u3)
        db.session.add(u4)
